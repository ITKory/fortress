...
export const metadata: Metadata = {
    ...
    description:
        "Авторская вайнахская кухня по халяль -стандартам. Жижиг-галнаш, чапильги, шашлыки, бургеры на мангале и многое другое- все по традиционным рецептам и только из халяльных продуктов.",
    ...
    openGraph: {
        title: "Башня. Вайнахская кухня - сеть ресторанов в Москве.",
        description:
            "Авторская вайнахская кухня по халяль -стандартам. Жижиг-галнаш, чапильги, шашлыки, бургеры на мангале и многое другое- все по традиционным рецептам и только из халяльных продуктов.",
